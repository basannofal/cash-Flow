...
import { deleteBorrowDepositeAsync, fetchPerMemberBorrowDepositeAsync, totalborrowdepositeAsync } from '@/store/slices/MemberBorrowDepositeSlice';
import { totalborrowpaymentAsync } from '@/store/slices/BorrowSlice';

const AllBorrowDeposite = ({ mid }) => {
    // Globel State Manegment
    const dispatch = useDispatch();
    const borrowdeposite = useSelector((state) => state.borrowdeposite.permemberborrowdeposite);
                                    ...
                                    rows.map((e, i) => {
                                        ...
                                        return (
                                            ...
                                            <tr key={e.id}>
                                                ...
                                                <td>
                                                    <Link href={`/memberdashboard/borrowpayment/editborrowdeposite?mid=${mid}&id=${e.id}`}>
