...
import {
  addReturnPaymentAsync,
  editReturnPaymentAsync,
  fetchPerReturnedPaymentAsync,
...
const EditReturnPayment = ({ mid, id }) => {
  ...
  const perreturnedpayment = useSelector(
    (state) => state.returnpayment.perreturnedpayment
  );
  ...
  useEffect(() => {
    const getdata = async () => {
      ...
      await dispatch(fetchPerReturnedPaymentAsync(id))
        .then((data) => {
                ...
                <div className={styles.column}>
                  <div className={styles.input_box}>
                    ...
                    <input
                      ...
                      name="widhrawername"
                      id="widhrawername"
                      value={PaymentData.widhrawername}
                      onChange={handleChange}
                      required
                    />
                  </div>
                    ...
                    <select name="cid" onChange={handleChange}>
                      ...
                      {categories.map((e, i) => {
                        if (e.id === PaymentData.cid) {
                          return (
                            <option selected key={e.id} value={e.id}>
                              {e.name}
                            </option>
                          );
                        } else {
                          // Add a condition to disable the "lillah" category
                          if (e.name === "lillah") {
                            return (
